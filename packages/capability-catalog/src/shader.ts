...
export class ShaderCapabilities {
  list(): Capability[] {
    ...
    const material = { ...guard, properties: materialProperties, defines: obj, states: obj, technique: integer, passIndex: { ...integer, description: '当前启用的渲染 Pass 索引，与 material.properties 的 rows[].pass 一致；工具映射到 Effect 原始编号。' } };
