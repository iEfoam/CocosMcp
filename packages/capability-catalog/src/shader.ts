...
export class ShaderCapabilities {
  list(): Capability[] {
    ...
    const material = { ...guard, properties: obj, defines: obj, states: obj, technique: integer, passIndex: integer };
    ...
    add('material.apply_runtime', '保存用户选定的运行时参数快照', 'asset', { ...guard, properties: obj, defines: obj, states: obj, passIndex: integer }, ['url', 'expectedHash', 'properties']);
    add('runtime.material.inspect', '查询组件材质实际参数与覆盖', 'read', target, ['componentId']);
    add('runtime.material.update', '创建独立材质实例并原子替换，失败保留原对象', 'runtime', { ...target, properties: obj, defines: obj, states: obj, passIndex: integer }, ['componentId']);
    ...
    add('runtime.shader.preview.update', '更新预览实例参数', 'runtime', { properties: obj, defines: obj, states: obj, passIndex: integer });
